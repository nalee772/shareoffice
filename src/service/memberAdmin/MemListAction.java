...
public class MemListAction implements CommandProcess {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response)
		...
		return "memberAdmin/memberList.jsp";   //경로
	}
