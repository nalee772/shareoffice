...
<body>
	...
	<!-- --------------------------------------------------------------------------------------------------------------------------------------------------------------- -->
	<main class="login_main"> <!-- 여기에 작성 -->

	<div class="login_container"></div>
	<form action="loginPro.do" method="post">
		<div class="login_container_main">
			<!-- ID 입력창 -->
			<div class="login_container_main-body">
				<div class="login_id_container">
					<label class="login_id_label" for="login_id_txt"> ID </label> 
					<input type="text" name="mbr_id" id="login_id_txt" class="form-control input-block">
				</div>
				<!-- /ID 입력창 -->
				...
				<div class="login_pw_container">
					<div class="pw_container">
						<div class="pw_label">
							<label for="login_pw_txt">Password </label> 
						</div>
						<div class="pw_find">
							<a class="login_label-link" href="findIdForm.do" id="find_pw">Forgot ID/password?</a>
						</div>
					</div>
					<input type="password" name="mbr_pw" id="login_pw_txt" class="form-control input-block">
				</div>
				<!-- /Password 입력창 -->
	...
	<!-- 회원가입 -->
	<div class="login_container_main_footer">
		<a class="label-link" href="joinForm.do" id="join_link">Create an
			account</a>
		<!-- 회원가입창으로 이동  -->
		<!--/회원가입 -->
	</div>
