...
<body>
    ...
    <!-- --------------------------------------------------------------------------------------------------------------------------------------------------------------- -->
     <main class="find_id_main">
       <!-- 여기에 작성 -->
		<form action="findIdPro.do" method="post" >
			<div class="findId_container_main">
					<!-- Email 입력창 -->		
				<div class="findId_container_main-body">
					 <label for="findId_em_txt"> E-mail </label>
					 <input type="text" name="mbr_email" id="findId_em_txt" class="form-control input-block" required="required"> 
					 <!-- /Email 입력창 -->	
					 		
					 <!-- 이름 입력창 -->			 
					 <label for="findId_name_txt">Name</label> 
				 	 <input type="text" name="mbr_name" id="findId_name_txt" class="form-control input-block"required="required"> 
				 	 <!-- /이름 입력창 -->	
				 	 
				 	 <!-- FindId_btn 아이디찾기 버튼 -->
					 <input type="submit" value="아이디 찾기" id="FindId_btn" class="btn btn-primary btn-block" >
					 <!-- FindId_btn 아이디찾기 버튼 -->								
				</div>
			</div>
		</form>
					<!-- 비밀번호 찾기 -->
		<div class="findId_container_main_footer" >
				<a class="label-link" href="findPwForm.do" id="join_link">비밀번호 찾기</a>
									<!-- 비밀번호 찾기 창으로 이동  -->				
					<!--/비밀번호 찾기 -->
		</div>
  <!-- ----------------------------------------------------------------------------------------------------------------------------------------------------------------- -->
