...
<body>
	...
	<!-- --------------------------------------------------------------------------------------------------------------------------------------------------------------- -->
	<main class="findPwPro_main"> <!-- 여기에 작성 -->
	<div class="findPwPro_container">
		<div class="findPwPro_container_main">
			<c:if test="${result > 0 }">
				<p class="findPwPro">회원님의 임시 비밀번호는 ${tempPw }입니다.</p>
				<p class="findPwPro">새로운 비밀번호로 로그인해주세요.</p>
			</c:if>
			<c:if test="${result <= 0 }">
				<p class="findPwPro">존재하지 않는 아이디 또는 이메일 주소입니다.</p>
			</c:if>
		</div>
	</div>
	...
	<!-- 로그인 --> 
	<c:if test="${result > 0 }">
		<div class="findPwPro_container_main_footer">
			<a class="label-link" href="loginForm.do" id="join_link">GO LOGIN</a>
		</div>
	</c:if> <!-- ----------------------------------------------------------------------------------------------------------------------------------------------------------------- -->
